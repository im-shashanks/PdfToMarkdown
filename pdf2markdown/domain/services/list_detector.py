...
from pdf2markdown.domain.models.document import Line, ListItem, ListBlock, ListMarker, ListType
    ...
    def detect_list_items_from_lines(self, lines: List[Line]) -> List[ListItem]:
        ...
        for line in lines:
            ...
            if marker:
                ...
                if current_item and self._is_continuation_line(line, current_item):
