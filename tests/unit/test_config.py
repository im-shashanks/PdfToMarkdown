...
from pdf2markdown.core.config import ConfigurationManager
from pdf2markdown.core.config import LoggingConfig
...
class TestLoggingConfig:
    ...
    def test_accepts_lowercase_logging_levels(self) -> None:
        ...
        assert config.level == "debug"  # Original value preserved
        # Validation logic should handle case insensitive comparison internally
